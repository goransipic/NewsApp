package com.example.android.newsapp.provider;

/**
 * Created by goransi on 29.6.2016..
 */
 ...
 * {@link com.example.android.newsapp.provider.FeedProvider}.
 */
public class FeedContract {
    ...
    public static class Entry implements BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.newsapp.entries";
        /**
         * MIME type for individual entries.
         */
        public static final String CONTENT_ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.newsapp.entry";
